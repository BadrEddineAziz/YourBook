<nav class="navbar fixed-top navbar-expand-md   " style="background-color:#1B4571;font-size:large; ">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav">
                    <a class="nav-link active" class="logo" style="color:#ffffff;font-size:large; text-align:center" href="{{ url('/admin') }}">
                    Home
                </a>
                <a class="nav-link active" class="logo" style="color:#ffffff;font-size:large; text-align:center" href="{{ route('createBook') }}">
                     Add Book
                </a>
                <a class="nav-link active" class="logo" style="color:#ffffff;font-size:large; text-align:center" href="{{ route('createCategorie') }}">
                    Add Categorie
                </a>
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <a class="nav-link active" class="logo" style="color:#ffffff;font-size:large; text-align:center" href="{{ route('search') }}">
                        <i class="fa fa-search"></i>
                </a>    @if(Auth::user()->admin == 1)
                            <a style="color:#ffffff;" class="nav-link" href="{{ route('home') }}"   >
                                   user side
                                </a>
                                @endif
