...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 25, 2023 at 10:28 PM
...
(48, '2023_06_23_202956_create_books_table', 1),
(49, '2023_06_23_204221_create_categories_table', 1),
(50, '2023_06_24_133330_create_pivot_book_categorie', 1);
...
(1, 'badreddine aziz', 'admin@admin.com', NULL, '$2y$10$QJB.jOyvbnmsQ9Z5j4iDluiqOwWiNX6uVBJFIYNQsCEy9OXyQwmu2', 1, NULL, '2023-06-25 19:17:15', '2023-06-25 19:17:15');
...
ALTER TABLE `book_categorie`
  ADD PRIMARY KEY (`id`),
  ADD KEY `book_categorie_book_id_foreign` (`book_id`),
